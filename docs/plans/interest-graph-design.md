...
| 优先级 | 功能 | 状态 |
|--------|------|------|
| P0 | 精炼结果详情页 + 用户反馈（点赞/收藏/踩/批注） | ✅ 已完成 |
| P1 | InterestPoint CRUD + 手动配置 | ✅ 已完成 |
| P2 | AI 分析任务（基于关键词聚类） | ✅ 已完成 |
| P2 | 兴趣图谱可视化页面（词云） | ✅ 已完成 |
| P3 | 兴趣驱动的通知过滤（interest_match 规则） | ⏳ 待实现（迭代二） |
| P3 | 兴趣匹配评分（interest_score 计算） | ⏳ 待实现（迭代二） |
| P3 | 反馈驱动权重调整 | ⏳ 待实现（迭代二） |
